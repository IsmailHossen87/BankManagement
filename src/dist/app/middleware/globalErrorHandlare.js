...
const handle_castError_1 = require("../helper/handle.castError");
const handle_zoderror_1 = require("../helper/handle.zoderror");
const handleValidateError_1 = require("../helper/handleValidateError");
...
const globalErrorHandler = (err, req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (err.code === 11000) {
        ...
        const simplifiedError = (0, handleValidateError_1.handleValidationError)(err);
        statusCode = simplifiedError.statusCode;
        message = simplifiedError.message;
        errorSources = simplifiedError.errorSources || [];
    }
