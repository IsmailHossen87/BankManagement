...
const verifyOTP = (email, otp) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield Promise.all([
        redis_config_1.redisClient.set(`otp:${email}:verified`, "true", { expiration: { type: "EX", value: 300 } }), // 5 min
...
const resetPassword = (email, newPassword) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isVerified = yield redis_config_1.redisClient.get(redisKey);
    if (!isVerified)
        throw new AppError_1.default(401, "OTP not verified or expired");
    const hashedPassword = yield bcryptjs_1.default.hash(newPassword, 10);
    const user = yield user_model_1.User.findOneAndUpdate({ email }, { password: hashedPassword }, { new: true, runValidators: true });
    if (!user) {
        throw new AppError_1.default(500, "Password update failed");
    }
